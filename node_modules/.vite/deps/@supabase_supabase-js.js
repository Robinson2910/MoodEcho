...
var resolveFetch = (customFetch) => {
  ...
  if (customFetch) {
    ...
    _fetch = (...args) => import("./browser-WCHR3SSN.js").then(({ default: fetch2 }) => fetch2(...args));
  } else {
    _fetch = fetch;
  }
...
var RealtimeClient = class {
  ...
  connect() {
    ...
    import("./browser-UVPJF4TP.js").then(({ default: WS }) => {
...
var resolveResponse = () => __awaiter2(void 0, void 0, void 0, function* () {
  if (typeof Response === "undefined") {
    return (yield import("./browser-WCHR3SSN.js")).Response;
  }
  return Response;
});
